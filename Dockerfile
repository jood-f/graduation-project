...
# This deployment uses CPU inference. Install CPU wheels first so Ultralytics
# does not pull several gigabytes of unused CUDA dependencies into the image.
