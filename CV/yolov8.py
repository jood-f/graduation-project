...
# CONFIGURATION
DATASET_PATH = r"C:\Users\raghad\OneDrive\Desktop\Senior_Project\graduation-project\CV\Solar_panel_Images"
BASE_OUTPUT = r"C:\Users\raghad\OneDrive\Desktop\Senior_Project\graduation-project\CV\YOLO_RESULTS"
...
# Validation metrics
print("\nCalculating metrics...")
metrics = det.val(data=yaml_path, split="test")
...
for idx, img_path in enumerate(sample):
    result = det.predict(img_path, conf=0.25, verbose=False)[0]
    img_bgr = result.plot()
...
for img_path in tqdm(val_image_paths):
    ...
    res = det.predict(img_path, imgsz=640, conf=CONF_THRES, verbose=False)[0]
